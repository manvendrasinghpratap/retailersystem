        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                {{-- <div class="d-inline-block ">
                    <a href="javascript:void(0);" title="Download as PDF" id="downloadpdf" data-downloadroutepdf="{{ route('downloadHotelpdf') }}" class="downloadpdf" value="Reset"><img width="16" src="{{ URL::asset('frontend/images/icon-pdf.png') }}" /></a>
                    <a download href="javascript:void(0);" title="Download as CSV" id="downloadproductcsv" data-downloadroutepdf="{{ route('downloadhotellistcsv') }}" class="downloadpdf" value="Reset"><img width="24" src="{{ URL::asset('frontend/images/csv.png') }}" /></a>
                </div> --}}
            </div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($account->user?->subscriptionStatus)
                                            @if($account->user?->subscriptionStatus->subscription->is_expired == 0)
