...
<nav class="navbar navbar-light navbar-expand-lg topnav-menu">
    ...
    $role . '.inventory*'
                ...
                <div class="dropdown-menu">
                    {{-- PRODUCT SETUP --}}
                    <h6 class="dropdown-header">Product Setup </h6>
                    ...
                    <div class="dropdown-divider"></div>
                    {{-- PROCUREMENT --}}
                    <h6 class="dropdown-header">Procurement </h6>
                    ...
                    <a href="{{ route('admin.stock_returns.index') }}" class="dropdown-item"><i data-feather="corner-up-left" class="menu-icon-sm"></i>@lang('translation.stock_returns')</a>
            ...
            <li class="nav-item dropdown {{ $isActive(['admin.requisitions.pending.posting', $role . '.sales-barcode', $role . '.return-barcode', $role . '.damage-barcode', $role . '.deduct-barcode']) ? 'active' : '' }}">
                ...
                <div class="dropdown-menu">
                    {{-- STOCK OPERATIONS --}}
                    <h6 class="dropdown-header">Stock Operations </h6>
                    ...
                    <div class="dropdown-divider"></div>
                    {{-- STOCK ADJUSTMENTS --}}
                    <h6 class="dropdown-header">Stock Adjustments </h6>
            ...
            <li class="nav-item dropdown {{ $isActive([$role . '.staff.*', 'admin.customers.*', 'admin.vendors.*']) ? 'active' : '' }}">
                ...
                <div class="dropdown-menu">
                    {{-- INTERNAL --}}
                    <h6 class="dropdown-header">Internal Users</h6>
                    ...
                    <div class="dropdown-divider"></div>
                    {{-- EXTERNAL --}}
                    <h6 class="dropdown-header">External Contacts</h6>
            ...
            <li class="nav-item dropdown {{ $isActive(['reports.*']) ? 'active' : '' }}">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="dropdown-divider"></div>
                    {{-- STAFF REPORTS --}}
                    <h6 class="dropdown-header">Staff Reports</h6>
