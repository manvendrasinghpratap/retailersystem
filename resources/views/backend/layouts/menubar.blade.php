    ...
    $role . '.inventory*'
            ...
            <li class="nav-item dropdown {{ $isActive(['admin.payment-types.*']) ? 'active' : '' }}" style="display: none-;">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="{{ route('admin.designations.index') }}" class="dropdown-item"><i data-feather="briefcase" class="menu-icon-sm"></i>@lang('translation.designations')</a>
                    <a href="{{ route('admin.modules.index') }}" class="dropdown-item"><i data-feather="box" class="menu-icon-sm"></i>@lang('translation.modules')</a>
                </div>
            </li>
        </ul>
    </div>
