                                ...
                                @if(!empty($customers) && $customers->count() > 0)
                                    ...
                                    @foreach($customers as $customer)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ \App\Helpers\Settings::getFormattedDatetime($customer->created_at) }}
                                            </td>

                                            <td>
                                                <x-href-input name="edit" label="Edit" href="{{ route('admin.customers.edit', ['id' => \App\Helpers\Settings::getEncodeCode($customer->id)]) }}" />

                                                <x-deletehref-input name="DeleteButton" label="Delete" href="javascript:void(0)" class="deleteData" data-deleteid="{{ \App\Helpers\Settings::getEncodeCode($customer->id) }}" data-routeurl="{{ route('admin.customers.softdelete', $customer->id) }}" />
                                            </td>
