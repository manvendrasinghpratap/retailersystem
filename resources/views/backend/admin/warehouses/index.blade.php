                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title d-inline-block">{{ __('translation.filter') }}</h4>
                     <div class="d-inline-block">
                        ...
                        'pdfId' =>'downloadwarehousepdf',    
                        'pdfRoute' => route('admin.warehouses.warehousePdf'),
                        'pdfClass' => 'downloadwarehousepdf',
                        'csvId' =>'downloadwarehousecsv',    
                        'csvRoute' => route('admin.warehouses.warehouseCsv'),
                        'csvClass' => 'downloadwarehousecsv',
                        ])                 
                    </div>      
                </div>
