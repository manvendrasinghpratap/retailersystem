    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET">
                    <div class="row">
                        <x-text-input name="product_name" label="{{ __('translation.product_name') }}" value="{{request('product_name')}}" mainrows="3" placeholder="{{ __('translation.product_name') }}"/>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title d-inline-block">
                    {{ __('translation.warehouse_products') }}:
                        ...
                        <tbody>
                             @forelse($products as $key => $product)
                                <tr>
                                    ...
                                    <td>{{ $product->name }}</td>
                                    <td>
                                        {{ optional($product->stocks->first())->stock ?? 0 }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
