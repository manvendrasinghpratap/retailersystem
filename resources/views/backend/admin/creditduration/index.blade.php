                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-inline-block">
                        ...
                        @include('backend.components.exportpdfcsv', [
                            ...
                            'pdfRoute' => route('admin.credit-line.exportPdf'),
                            'pdfClass' => 'downloadcreditdurationpdf',

                            'csvId' => 'downloadcreditdurationcsv',
                            'csvRoute' => route('admin.credit-line.exportCsv'),
                ...
                <div class="card-body">
                    ...
                    <form method="GET">
                        ...
                        <div class="row">
                            ...
                            <x-text-input name="duration_days" label="{{ __('translation.duration_days') }}" type="number" value="{{ request()->get('duration_days') }}" mainrows="2" />
                                ...
                                @forelse($creditDurations as $creditDuration)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <x-href-input name="edit" label="{{ __('translation.edit') }}" href="{{ route('admin.credit-line.edit', \App\Helpers\Settings::getEncodeCode($creditDuration->id)) }}" />

                                            <x-deletehref-input name="DeleteButton" label="{{ __('translation.delete') }}" href="javascript:void(0)" class="deleteData" data-deleteid="{{ \App\Helpers\Settings::getEncodeCode($creditDuration->id) }}" data-routeurl="{{ route('admin.credit-line.destroy', $creditDuration->id) }}" />
