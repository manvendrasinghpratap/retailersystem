...
<head>
    ...
    <meta name="author" content=" {{config('app.name')}} | Manvendra Pratap Singh | 8707643218">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="lead mb-4">
                    Manage billing, inventory, sales, and customers from one powerful cloud platform designed for modern retail stores.
                </p>
            ...
            <div class="col-lg-5 mb-4">
                <div class="p-4 bg-white rounded-4 shadow-sm h-100">
                    ...
                    <p class="mb-0">
                        ...
                        Retailer System Tech Park, Logas, Negeria   
                    </p>
