                ...
                <div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white per-40 mt-per-80">
                    <div class="my-auto authentication-pages">
                        <div class="d-flex align-items-center mb-3">
                            <img src="{{ asset('assets/images/logo.png') }}" class="width30per me-2" alt="logo @lang('translation.webname')">
                ...
                <div class="p-5 wd-md-50p per-60">
                    <div class="main-signin-header">
                        ...
                        <form method="POST" action="{{ route('login') }}" autocomplete="off">
                            @csrf
                            <x-input-field id="email" :label="__('translation.emailorusername')" type="text" name="login" value="{{ old('email') }}" placeholder="{{ __('translation.emailorusername') }}" autofocus class="form-control" autocomplete="new-email" />
                    ...
                    <div class="main-signin-footer mt-1 mg-t-1">
                        <p>
                            <a href="{{ route('password.request') }}">@lang('translation.forgot_password')</a>
                        </p>
                        <!-- <p>
                            @lang('translation.Dont_have_an_account')
                            <a href="{{ route('register') }}">@lang('translation.create_account')</a>
                        </p> -->
                    </div>
                </div>
            </div>
